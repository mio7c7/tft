...
python pytorch_forecasting/CPD/ATtest.py --max_encoder_length 336 --method 'quantile' --max_prediction_length 96 --quantile 0.975 --threshold_scale 1.25 --step 50 --outfile 'atest' --model_path '/default_o1_5d2d/trial_13/epoch=88.ckpt'