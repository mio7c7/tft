...
if __name__ == '__main__':
    ...
    for tank_sample_id in list(test_sequence['group_id'].unique()):
        ...
        preds = [idx+args.max_prediction_length for idx in range(len(scores)) if scores[idx] > thresholds[idx]]
        ...
        np.savez(args.path, no_CPs=no_CPs, no_preds=no_preds, no_TPS=no_TPS)
