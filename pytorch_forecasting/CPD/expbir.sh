...
python pytorch_forecasting/CPD/main_nooutlierremoval.py --max_encoder_length 336 --quantile 0.975 --threshold_scale 1.25 --step 50 --outfile 'nooutlier' --model_path '/default_r2_7d2d/trial_23/epoch=96.ckpt'
